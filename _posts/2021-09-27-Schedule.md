...
- Thursday:
	- For next time:
		- [Max Tegmark: AI and Physics, Lex Fridman Podcast](https://www.youtube.com/watch?v=RL4j4KPwNGM), relevant portions to 2:35:42

## Week 12 (11/15)
- Tuesday:
	- Introduce Assignment 4 & plan presentations
	- For next time:
		- [How to be a data detective, Rationally Speaking Podcast](http://rationallyspeakingpodcast.org/256-how-to-be-a-data-detective-tim-harford/) with Julia Galef and Tim Harford
- Thursday:
	- For next time:
