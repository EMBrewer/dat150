...
- Tuesday:
	...
	- For next time:
		- [Andrew on MLOps: From Model-centric to Data-centric AI](https://www.youtube.com/watch?v=06-AZXmwHjo)
- Thursday:
	- For next time:
...
- Tuesday:
	- For next time:
		- [Combining satellite imagery and machine learning to predict poverty](https://www.science.org/doi/10.1126/science.aaf7894) by Alegana et al.
- Thursday:
	- For next time:
...
- Tuesday:
	- For next time:
		- [Geoff West, Scale](https://dsfall21.slack.com/files/U02DA5H2NGJ/F02EVA0KH8V/west_scale.pdf), pages 431-431
- Thursday:
	- For next time:
